...
<body>
    <header class="profile-header">
        <div class="container header-inner">
            ...
            <nav class="header-links"><a href="${pageContext.request.contextPath}/index.jsp">Trang chủ</a><a href="${pageContext.request.contextPath}/examination-history">Lịch sử khám</a><a class="logout" href="${pageContext.request.contextPath}/auth/logout">Đăng xuất</a></nav>
        </div>
    </header>
        ...
        <div class="profile-layout">
            <aside class="profile-sidebar">
                ...
                <nav class="profile-tabs" aria-label="Cài đặt hồ sơ">
                    ...
                    <a href="${pageContext.request.contextPath}/examination-history"><span>◷</span> Lịch sử khám</a>
                </nav>
            </aside>
