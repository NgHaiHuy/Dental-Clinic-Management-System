                    ...
                    <div class="account-menu">
                        ...
                        <div class="account-dropdown" role="menu">
                            <% if (roleId == 4) { %>
                                ...
                                <a href="${pageContext.request.contextPath}/booking" role="menuitem">Lịch sử khám của tôi</a>
                            ...
                            <% } else if (roleId == 2) { %>
                                ...
                                <a href="${pageContext.request.contextPath}/booking" role="menuitem">Lịch sử ca đã khám</a>
                            <% } else if (roleId == 3) { %>
                                ...
                                <a href="${pageContext.request.contextPath}/booking" role="menuitem">Lịch sử khám toàn bộ</a>
