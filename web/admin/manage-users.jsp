    ...
    <div class="modal">
        ...
        <form action="${pageContext.request.contextPath}/admin/manage-users" method="POST">
            ...
            <div class="modal-form-group">
                ...
                <input type="tel" name="phone" class="modal-input" placeholder="0912345678" required pattern="0[389]\d{8}" title="Số điện thoại phải gồm 10 chữ số và bắt đầu bằng 03, 08 hoặc 09" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
            </div>
            <div class="modal-form-group">
...
<div class="modal-overlay" id="editModal">
    <div class="modal">
        ...
        <form action="${pageContext.request.contextPath}/admin/manage-users" method="POST">
            ...
            <div class="modal-form-group">
                <label class="modal-label">Số điện thoại *</label>
                <input type="tel" name="phone" id="editPhone" class="modal-input" required pattern="0[389]\d{8}" title="Số điện thoại phải gồm 10 chữ số và bắt đầu bằng 03, 08 hoặc 09" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
            </div>
            <div class="modal-form-group">
                <label class="modal-label">Email</label>
