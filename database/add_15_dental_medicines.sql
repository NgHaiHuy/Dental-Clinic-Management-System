...
BEGIN
    ...
    VALUES (N'Nước súc miệng trị viêm nướu Chlorhexidine 0.12%', N'Chai', 150000.00, 80, 1, '/img/chlorhexidine.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Kháng sinh răng miệng Clindamycin 300mg', N'Hộp', 120000.00, 100, 1, '/img/clindamycin.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Kháng sinh viêm nha chu Metronidazole 250mg', N'Hộp', 45000.00, 200, 1, '/img/metronidazole.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Kem đánh răng Sensodyne Repair & Protect', N'Tuýp', 95000.00, 150, 1, '/img/sensodyne_repair.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Kem đánh răng cho răng niềng Colgate Ortho', N'Tuýp', 75000.00, 100, 1, '/img/colgate_ortho.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Nước súc miệng ngừa viêm nướu Kin Gingival', N'Chai', 135000.00, 90, 1, '/img/kin_gingival.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Nước súc miệng diệt khuẩn Listerine Cool Mint', N'Chai', 80000.00, 300, 1, '/img/listerine_coolmint.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Gel bôi trị nhiệt miệng loét nướu Aloclair Plus', N'Tuýp', 165000.00, 50, 1, '/img/aloclair_plus.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Gel gây tê giảm đau miệng Kamistad Gel N', N'Tuýp', 90000.00, 120, 1, '/img/kamistad_gel.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Gel đặc trị ê buốt cổ chân răng Emofluor', N'Tuýp', 220000.00, 40, 1, '/img/emofluor.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Chỉ tơ nha khoa làm sạch kẽ răng Dentana', N'Cuộn', 35000.00, 250, 1, '/img/dentana_floss.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Đầu phun máy tăm nước Waterpik Jet Tip', N'Cái', 150000.00, 60, 1, '/img/waterpik_jettip.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Bàn chải chuyên dụng răng niềng TePe Ortho', N'Cái', 75000.00, 110, 1, '/img/tepe_ortho.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Bàn chải siêu mềm bảo vệ nướu Curaprox CS 5460', N'Cái', 115000.00, 180, 1, '/img/curaprox.png');
END
...
BEGIN
    INSERT INTO Medicines (MedicineName, Unit, Price, StockQuantity, Status, ImagePath)
    VALUES (N'Kem bôi tái khoáng ngừa sâu răng GC Tooth Mousse', N'Tuýp', 320000.00, 30, 1, '/img/tooth_mousse.png');
END
GO
